// Go 中最主要的状态管理方式是通过通道间的沟通完成的，我们
// 在[工作池](worker-pools.html)例子中碰到过，但是还是有一
// 些其他的方法来管理状态。这里我们将看到如何使用 `sync/atomic`
// 包在多个 Go 协程中进行_原子计数_ 。
